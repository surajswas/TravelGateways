...
import 'package:localhotel/travel/travel_card.dart';
import 'package:localhotel/travel/travel_details.dart';
...
// void main() {
//   runApp(
//       MaterialApp(debugShowCheckedModeBanner: false, home: BottomNavigation()));
// }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Pick your local tourism destination",
              style: TextStyle(
                color: Colors.black,
                fontSize: 20.0,
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  child:
                                      ...
                                      Container(
                                    child: travelCard(
                                        urls[0], "Pokhara Hotel", "Pokhara", 3),
                                  ),
                                ),

                                travelCard(urls[0], "KTM Hotel", "Thamel", 3),
                                travelCard(
                                    urls[5], "Plaza Hotel", "Lalitpur", 4),
                              ],
                            ),
                          ),
                          Container(
